...
class Ground():
	def __init__(self):
		self.image = pygame.image.load('assets\scenario\scenario-ground.png')
...
class Samurai():
	def __init__(self, x, y):
		...
		for i in range(1, 9):
			img = pygame.image.load(f'assets\samurai-run\samurai-run-{i}.png')
			img = pygame.transform.scale(img, (52, 58))
			self.run_list.append(img)

		for i in range(1, 3):
			img = pygame.image.load(f'assets\samurai-bent-down\samurai-bent-down-{i}.png')
			img = pygame.transform.scale(img, (70, 38))
			self.duck_list.append(img)

		self.dead_image = pygame.image.load('assets\samurai-dead\samurai-dead-3.png')
		self.dead_image = pygame.transform.scale(self.dead_image, (75,10))
...
class Obstacle(pygame.sprite.Sprite):
	def __init__(self, type):
		...
		for i in range(14):
			scale = 0.65
			img = pygame.image.load(f'assets\obstacles\obstacle-{i+1}.png')
			w, h = img.get_size()
...
class Bird(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		for i in range(6):
			# scale = 0.65
			img = pygame.image.load(f'assets/bird/bird-{i+1}.png')
			# w, h = img.get_size()
			img = pygame.transform.scale(img, (int(52), int(28)))
			self.image_list.append(img)
...
class Cloud(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.image = pygame.image.load('assets\scenario\scenario-cloud-1.png')
